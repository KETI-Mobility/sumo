...
class C_VEH(_C_VEH):
	...
	def update(self, new_location, new_speed, new_acceleration, new_lane, new_route, vehicle_edge, vehicle_route_index, vehicle_waiting_time, vehicle_accumulated_waiting_time) -> None:
		self.stay = True
		...
		self.vehicle_edge = vehicle_edge
		self.vehicle_route_index = vehicle_route_index
		self.vehicle_waiting_time = vehicle_waiting_time
	...
	def create_bsm(self) -> BSM:
		bsm = BSM(self.vehicle_id, self.vehicle_type, self.rsu_location, self.vehicle_speed, self.vehicle_location, self.vehicle_size, None, None, None, None, None, None, self.vehicle_waiting_time, self.vehicle_edge)
		return bsm
...
class E_CDA(_C_VEH):
	...
	def create_bsm(self) -> BSM:
		bsm = BSM(self.vehicle_id, self.vehicle_type, self.rsu_location, self.vehicle_speed, self.vehicle_location, self.vehicle_size, None, None, None, None, None, None, 0, self.vehicle_edge)
		return bsm
