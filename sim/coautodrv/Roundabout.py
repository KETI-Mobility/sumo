...
def get_data(vehicle_id) -> Union[T_CDA, E_CDA, C_VEH, CE_VEH, N_VEH]:
	...
	if the_vehicle is None:
		if vehicle_type[:5] == "C-VEH":
			the_vehicle = C_VEH(GlobalSim.step, vehicle_id, vehicle_type, rsu_location, vehicle_speed, vehicle_position, (vehicle_length, vehicle_width))
		elif vehicle_type[:6] == "CE-VEH":
			the_vehicle = CE_VEH(GlobalSim.step, vehicle_id, vehicle_type, rsu_location, vehicle_speed, vehicle_position, (vehicle_length, vehicle_width))
