...
class BSM(Message):
	...
	def __init__(self, sender_vehicle_id, sender_vehicle_type, rsu_location, sender_speed, sender_location, sender_vehicle_size, sender_evelivation, sender_position_accuracy, sender_heading, sender_steering_angle, sender_brake_status, sender_acceleration, sender_waiting_time, sender_edge_id):
		...
		self.sender_waiting_time		= sender_waiting_time
...
class DetectMessage(Message):
	...
	def __init__(self, infra_type, vehicle_id, vehicle_type, rsu_location, vehicle_speed, vehicle_location, sender_acceleration, detect_edge_id, next_route):
